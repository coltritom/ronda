...
function SkeletonGroupCard() {
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-border bg-surface p-4 animate-pulse">
      {/* Avatar */}
      <div className="h-12 w-12 flex-shrink-0 rounded-2xl bg-muted/20" />

      {/* Info */}
      <div className="flex-1 space-y-2">
        <div className="flex items-center gap-2">
          <div className="h-4 w-36 rounded-md bg-muted/20" />
          <div className="h-4 w-12 rounded-full bg-muted/20" />
        </div>
        <div className="h-3.5 w-52 rounded bg-muted/20" />
        <div className="h-3 w-20 rounded bg-muted/20" />
      </div>

      {/* Chevron */}
      <div className="h-4 w-4 flex-shrink-0 rounded bg-muted/20" />
    </div>
  )
}
