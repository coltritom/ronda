        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full">
          ...
          <div className="w-full bg-noche-media rounded-2xl p-4 text-center">
            ...
            <button
              onClick={() => {
                const link = `${window.location.origin}/invite/${groupId}`;
                const text = encodeURIComponent(`Entrá a mi grupo en Ronda: ${link}`);
                window.open(`https://wa.me/?text=${text}`, "_blank");
              }}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#25D366]/10 text-[#25D366] font-semibold text-sm border-none cursor-pointer hover:bg-[#25D366]/15 transition-colors">
