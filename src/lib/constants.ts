...
export const MOCK_GROUP_DETAILS: Record<string, GroupDetail> = {
  g1: {
    ...
    juntadas: [
      { id: "j1", isoDate: "2026-03-29", date: "Sáb 29 mar", name: "Asado en lo de Mati", attendees: 6, totalSpent: 18200, closed: true, lugarId: "casa", hostName: "Mati" },
      { id: "j2", isoDate: "2026-04-05", date: "Sáb 5 abr", name: "Pizzas + fútbol", attendees: 7, totalSpent: 12400, closed: false, lugarId: "restaurant" },
    ...
    wrapped: { totalJuntadas: 14, totalSpent: 182000, topPresente: "Mati", topFantasma: "Nico", fantasmaFaltas: 6 },
  },
  g2: {
    pending: null,
    juntadas: [
      { id: "j3", isoDate: "2026-04-02", date: "Mié 2 abr", name: "Fútbol miércoles", attendees: 9, totalSpent: 3600, closed: true, lugarId: "futbol5" },
      { id: "j4", isoDate: "2026-03-26", date: "Mié 26 mar", name: "Fútbol miércoles", attendees: 10, totalSpent: 4000, closed: true, lugarId: "futbol5" },
      { id: "j3-next", isoDate: "2026-04-16", date: "Mié 16 abr, 21:00", name: "Fútbol miércoles", attendees: 0, totalSpent: 0, closed: false, lugarId: "futbol5", confirmed: 8, unsure: 2, noResponse: 1 },
    ],
    ranking: [
    ...
    wrapped: { totalJuntadas: 22, totalSpent: 88000, topPresente: "Nico", topFantasma: "Facu", fantasmaFaltas: 8 },
  },
  g3: {
