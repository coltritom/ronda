-- Fix RPCs to filter event_attendance by attended = true.
-- Now that "No fui" is stored as attended = false, queries that count
-- actual attendees must exclude those negative records.
