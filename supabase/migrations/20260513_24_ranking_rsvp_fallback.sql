-- Ranking widget: fall back to RSVP "going" for past events with no attendance records.
-- If a past event has at least one event_attendance row with attended=true, use those.
-- If nobody recorded attendance for an event, treat RSVP "going" as proxy attendance.
